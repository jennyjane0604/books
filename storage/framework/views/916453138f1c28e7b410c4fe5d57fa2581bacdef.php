<?php $__env->startSection('content'); ?>
  <section class="row" style="margin:0;">
    ...
    <form action="<?php echo e(url('/books/edit/save')); ?>" method='post' class="form">
        ...
        <?php endif; ?>
            ...
            <input type="text" name="isbn" id="isbn" class="form-control"  value="<?php echo e($book->isbn); ?>" readonly>
        </section>
        <section class="form-group">
            ...
            <input type="text" name="booktitle" id="booktitle" class="form-control" value="<?php echo e($book->bookTitle); ?>">
        </section>
        <section class="form-group">
            ...
            <input type="text" name="bookauthor" id="bookauthor" class="form-control" value="<?php echo e($book->bookAuthor); ?>">
        </section>
...
<?php echo $__env->make('books.bookmainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\dev\laravel\myproject\resources\views/books/editbook.blade.php ENDPATH**/ ?>